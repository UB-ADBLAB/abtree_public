					  ...
					  bool indexonly)
{
	...
	if (indexonly)
		scan_plan = (Scan *) make_indexonlyscan(tlist,
												...
												best_path->is_sample_scan,
												best_path->sample_size,
												best_path->repeatable_expr,
												best_path->sample_size_expr);
	else
			   ...
			   Expr *sample_size_expr)
{
	...
	node->is_sample_scan = is_sample_scan;
	node->sample_size = sample_size;
	node->repeatable_expr = repeatable_expr;
	node->sample_size_expr = sample_size_expr;
