...
/* ----------------
 * Additional states for index sample scans. This struct is the common part
 * of IndexScanState and IndexOnlyScanState.
 ...
 * ----------------
 */
typedef struct IndexSampleScanState
{
	uint64		isss_SampleSize;
	uint64		isss_RemSampleSize;
	double		isss_HighRejectionRateWarningThreshold;
	uint64		isss_NumIndexAccessAttempted;
	uint32		isss_Seed;
	bool		isss_RescanForRuntimeKeysOnly;
	SamplerRandomState	isss_RandState;
	ExprState	*isss_RepeatableExprState;
	ExprState	*isss_SampleSizeExprState;
} IndexSampleScanState;
 ...
 *
 *		IndexSampleScanState the states needed for index sample scan
 * ----------------
 */
typedef struct IndexScanState
{
	...
	IndexSampleScanState iss_IndexSampleScanState;
} IndexScanState;
...
typedef struct IndexOnlyScanState
{
	...
	IndexSampleScanState ioss_IndexSampleScanState;
} IndexOnlyScanState;
