...
typedef struct IndexScan
{
	...
	bool		is_sample_scan;	/* true if this is a sample scan */
	uint64		sample_size;	/*
								 * number of samples to fetch if this is a
								 * index sample scam.
								 * */
	Expr		*repeatable_expr;/* The repeatable expression for tablesample.*/
	Expr		*sample_size_expr; /* Non-null if the sample size is not constant. */
} IndexScan;
