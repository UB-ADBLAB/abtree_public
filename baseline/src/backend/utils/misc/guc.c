...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"tablesample_swr_ask_for_samples_attempted", PGC_USERSET, LOGGING_WHAT,
			gettext_noop("Sets whether tablesample swr should issue a NOTICE "
						 "level message of \"N=<Number of Samples Attempted>.\"")
		},
