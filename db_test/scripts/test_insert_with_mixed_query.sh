...
if [ $# -lt 4 ]; then
	echo "usage: $0 <tree> <ninsert_threads> <nquery_threads> <seed>"
	exit 1
fi
...
echo "testing..."
PREFIX="logs/ins_w_mixedq${SEED}_${TREE}_nfixed${NFIXED}_n${N}_S${BUFSIZE}_warm"
./run test.MixedWorkload -i test_abtree $NFIXED ${SEED} 0 0 0 10000 $N \
