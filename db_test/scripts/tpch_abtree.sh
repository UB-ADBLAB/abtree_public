...
BUILD="release"
src_data=/mnt/ssd1/zyzhao/loaded_data/tpch_100g_abtree
src_pgwal=/mnt/ssd1/zyzhao/loaded_data/tpch_100g_abtree_pg_wal
...
PREFIX="logs/tpch_abtree_${BUFSIZE}_warm"
