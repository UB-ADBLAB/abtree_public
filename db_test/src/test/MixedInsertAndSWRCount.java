...
public class MixedInsertAndSWRCount {
	public static void main(String args[]) throws IOException {
		...
		if (args.length - args_base < 7) {
			System.out.println(
				"usage: test.MixedInsertAndSWRCount [-i] <dbname> " +
				"<ninserts> <ninsert_threads> <seed> " +
		...
		if (args.length - args_base > 7) {
			...
			meter_file = String.format(
				"MixedInsertAndSWRCount_%04d%02d%02d-%02d%02d%02d.meter",
